...
public class DialogHelper {
	...
	public static GDXButtonDialog yesNoMaybeBox(String title, String message, final Runnable positiveRunnable, final Runnable negativeRunnable, final Runnable maybeRunnable) {
		final GDXButtonDialog dialog = dialogs.newDialog(GDXButtonDialog.class);
		...
		dialog.setClickListener(new ButtonClickListener() {
			...
			public void click(int button) {
				if (button == 1) {
					...
					if (maybeRunnable != null) maybeRunnable.run();
					dialog.dismiss();
				}
			}
		...
		dialog.addButton("No");
		dialog.addButton("Yes");
		dialog.addButton("Maybe");

		return dialog;
	}

	public static GDXButtonDialog yesNoMaybeBox(String title, String message, String yesText, final Runnable positiveRunnable, String noText, final Runnable negativeRunnable, String maybeText, final Runnable maybeRunnable) {
		final GDXButtonDialog dialog = dialogs.newDialog(GDXButtonDialog.class);
