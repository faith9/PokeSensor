...
@ObjCClassName("NotificationFilterTableCell")
@RegisterOnStartup
public class NotificationFilterTableCell extends UITableViewCell {
    ...
    protected NotificationFilterTableCell(Pointer peer) {
        super(peer);
    }
    ...
    public void toggleFilter() {
        MapController.features.notificationFilter.put(pokedexNumber, toggle.isOn());
    }
