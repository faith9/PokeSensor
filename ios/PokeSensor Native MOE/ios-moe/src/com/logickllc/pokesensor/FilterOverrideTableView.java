...
@ObjCClassName("FilterOverrideTableView")
@RegisterOnStartup
public class FilterOverrideTableView extends UITableView {
    Hashtable<String, UIImage> images = new Hashtable<String, UIImage>();

    protected FilterOverrideTableView(Pointer peer) {
        super(peer);
    }
    ...
    public void setup() {
        setDataSource(new UITableViewDataSource() {
            ...
            public UITableViewCell tableViewCellForRowAtIndexPath(UITableView table, NSIndexPath path) {
                ...
                FilterOverrideTableCell cell = (FilterOverrideTableCell) table.dequeueReusableCellWithIdentifierForIndexPath("cell", path);
                ...
                cell.toggle.setOn(MapController.features.filterOverrides.get(pokedexNumber));
