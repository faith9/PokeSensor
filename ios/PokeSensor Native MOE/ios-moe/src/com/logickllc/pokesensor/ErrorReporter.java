...
public class ErrorReporter {
    ...
    public static void logException(final Throwable t, final Map<String, String> extras) {
        try {
            ...
            String ios = UIDevice.currentDevice().systemVersion();
    ...
    public static void logException(final NSException t, final Map<String, String> extras) {
        try {
            MapController.features.print("ErrorReporter", "Preparing native iOS error report for " + t.name());
            Map<String, String> params = new HashMap<String, String>();
            ...
            int counter = 0;
            NSArray<String> stack = t.callStackSymbols();
            ...
            String message = t.reason();
            if (message == null) message = "Native crash with no reason...";
            MapController.features.print("ErrorReporter", "Submitting native iOS error report for " + t.name());
            //Flurry.logEvent(name + ": " + message, params);
