...
public class AdHelper {
	...
	private static String PREF_SHOW_ADS = "ShowAds";
	...
	public static float getSmartBannerHeight() {
		...
		float density = Gdx.graphics.getDensity();  // Screen width of this device (in pixels)
	...
	public static void removeAds(String prefsName) {
		Preferences prefs = Gdx.app.getPreferences(prefsName);
		prefs.putBoolean(PREF_SHOW_ADS, false);
		prefs.flush();
