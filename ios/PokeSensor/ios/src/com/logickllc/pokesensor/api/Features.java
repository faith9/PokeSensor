...
public abstract class Features {
	...
	/*public synchronized void tryTalkingToServer(final PokemonGo go) throws LoginFailedException, RemoteServerException {
		serverAlive = null;
		...
		Thread thread = new Thread() {
			public void run() {
				try {
					...
					else if (e instanceof RemoteServerException) serverAlive = true;
