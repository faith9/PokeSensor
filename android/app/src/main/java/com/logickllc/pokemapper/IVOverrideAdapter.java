...
public class IVOverrideAdapter extends BaseAdapter {
    Activity act;
    LayoutInflater inflater;

    public IVOverrideAdapter(Activity act) {
        this.act = act;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.toggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    PokeFinderActivity.features.filterOverrides.put(holder.pokedexNumber, isChecked);
                }
            });
        ...
        holder.toggle.setChecked(PokeFinderActivity.features.filterOverrides.get(holder.pokedexNumber));
